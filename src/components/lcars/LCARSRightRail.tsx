...
const LCARSRightRail: React.FC<LCARSRightRailProps> = ({ className }) => {
  ...
  return (
    <div className={cn("h-full bg-lcars-black flex flex-col border-l border-lcars-blue/20 overflow-hidden", className)}>
      {/* System Readouts */}
      <div className="p-4 space-y-4 flex-1 overflow-auto">
        <div className="text-lcars-light-gray font-lcars-sans text-sm uppercase tracking-wider font-bold border-b border-lcars-blue/30 pb-2">
          SYSTEM STATUS
        </div>

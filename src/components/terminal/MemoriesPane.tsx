  ...
  return (
    <div className="h-full flex flex-col">
      <Tabs defaultValue="history" className="h-full flex flex-col">
        <TabsList className="grid w-full grid-cols-3 flex-shrink-0 bg-transparent gap-2 p-0 h-auto">
          <TabsTrigger 
            value="history" 
            className="lcars-tab flex items-center gap-2 text-xs sm:text-sm font-bold px-2 sm:px-4 py-2 data-[state=active]:bg-lcars-purple data-[state=active]:text-white"
          >
          ...
          <TabsTrigger 
            value="projects" 
            className="lcars-tab flex items-center gap-2 text-xs sm:text-sm font-bold px-2 sm:px-4 py-2 data-[state=active]:bg-lcars-cyan data-[state=active]:text-white"
          >
            <FolderOpen className="w-4 h-4 flex-shrink-0" />
            <span className="hidden sm:inline">Projects History</span>
            <span className="sm:hidden">Projects</span>
          </TabsTrigger>
          <TabsTrigger 
            value="memories" 
            className="lcars-tab flex items-center gap-2 text-xs sm:text-sm font-bold px-2 sm:px-4 py-2 data-[state=active]:bg-lcars-orange data-[state=active]:text-white"
          >

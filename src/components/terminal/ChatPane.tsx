...
export const ChatPane = () => {
  ...
  return (
    <div className="h-full flex flex-col lg:flex-row gap-4 px-4 pb-4 pt-1 lg:overflow-visible relative">
      {/* Chat Section */}
      ...
      <Card className="w-full lg:w-80 flex flex-col h-full min-h-[400px] lg:sticky lg:top-4 lg:self-start lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto">

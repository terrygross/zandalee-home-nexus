...
export const ProjectChatPane = ({ selectedProject }: ProjectChatPaneProps) => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full">
      {/* Main Chat Section - Takes priority in mobile, left side in desktop */}
      <div className="flex-1 min-h-0 order-1">
        <ChatInterface />
      </div>

      {/* Memory & Diary Sidebar - Bottom in mobile, right side in desktop */}
      <aside className="w-full md:w-80 lg:w-96 flex-shrink-0 border-t md:border-t-0 md:border-l border-border/50 order-2">

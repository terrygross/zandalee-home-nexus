...
export const ProjectChatPane = ({ selectedProject }: ProjectChatPaneProps) => {
  return (
    <div className="flex flex-col md:flex-row h-full gap-4 p-4">
      {/* Main Chat Section - Takes full width on mobile (order-2), left side on desktop */}
      ...
      {/* Memory Manager - Bottom on mobile (order-1), right side on desktop */}
      <div className="w-full md:w-80 lg:w-96 flex-shrink-0 order-1 md:order-2 min-h-0">

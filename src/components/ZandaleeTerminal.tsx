...
import { MessageCircle, Settings, Mic, Hand, FileText, Brain, Volume2, Code } from 'lucide-react';
    ...
    <div className="flex flex-col min-h-[100dvh] w-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-h-0 px-4 py-1">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
          <TabsList className="flex-shrink-0 grid w-full grid-cols-8 mb-1 h-auto min-h-[3rem] overflow-x-auto gap-2 whitespace-nowrap">

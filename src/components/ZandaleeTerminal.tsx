    ...
    <div className="flex flex-col min-h-[100dvh] w-screen bg-background">
      ...
      <div className="flex-1 flex flex-col min-h-0 px-4 py-1">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
          ...
          <TabsList className={`flex-shrink-0 grid w-full ${canInviteUsers(user) ? 'grid-cols-10' : 'grid-cols-9'} mb-1 h-auto min-h-[3rem] overflow-x-auto gap-2 whitespace-nowrap sticky top-0 z-50 bg-background/95 backdrop-blur-sm`}>
